...
question_t_f('Czy produkt jest niezgodny z opisem', 'Reklamacja przyjeta', 'Czy produkt nie dotarl?').
question_t_f('Czy produkt nie dotarl?', 'Zglos brak przesylki pod numerem 503 503 503', 'Prosze wybrac jedna z przyczyn').
...
answer('Zglos brak przesylki pod numerem 503 503 503', 'Zglos brak przesylki pod numerem 503 503 503', 'N').
