...
class TestRegularizedModelSelection(TestCase):
    ...
    def test_regularized_model_selection_train_err(self):
        ...
        _, train_err, _, _ = regularized_model_selection(x_train, y_train, x_val, y_val, M,
                                                         lambda_values)
    ...
    def test_regularized_model_selection_val_err(self):
        ...
        _, _, val_err, _ = regularized_model_selection(x_train, y_train, x_val, y_val, M,
                                                       lambda_values)
    ...
    def test_regularized_model_selection_lambda(self):
        ...
        _, _, _, lambda_ = regularized_model_selection(x_train, y_train, x_val, y_val, M,
                                                       lambda_values)
